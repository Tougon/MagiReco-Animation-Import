...
/// <summary>
/// Imports animation from MagiReco
/// </summary>
/// @author Evan McGrath
public class MagiRecoArmatureImport
{

    public const float scale_factor = 100.0f;
    public const float sample_rate = 60.0f;

    // Imports animation from MagiReco given an exported armature data file and its associated texture atlas and config data
    [MenuItem("Character/Import from MagiReco")]
